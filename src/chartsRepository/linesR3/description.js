...
const miniDescription = <div>
  ...
  <p>Our chart is pretty explicit with the fact that a line is a infinite set of points in <Latex>{"$R_n$"}</Latex>, which follow the same direction. It means if you the direction of <Latex>{"$A$"}</Latex> the line will change its <b>slope</b>. And, if you change <Latex>{"$P$"}</Latex> the line will change its <b>position</b>. </p>
</div>
